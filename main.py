"""
FastAPI application for KinasePred microservice
"""
...
from kinasepred_handler import KinasePredHanlder

app = FastAPI(
    title="KinasePred Microservice",
    description="Molecular property prediction service using KinasePred models",
    version="0.1.0"
)
